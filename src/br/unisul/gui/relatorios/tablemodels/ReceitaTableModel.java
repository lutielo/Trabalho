...
/**
 * Implementação de Table Model para exibir as Receitas.
 */
public class ReceitaTableModel extends AbstractTableModel {
	...
	private String[] colunas = new String[] { "Código", "Nome", "Autor", "Data Criação"};
	...
	public Class<?> getColumnClass(int columnIndex) {
		...
		switch (columnIndex) {
			...
			case 1: // Segunda coluna é o Nome, que é uma String..
				return String.class;
			case 2: // Terceira coluna é o nome do Autor,
					// que também é uma String
				return String.class;
			case 3: // Quarta coluna é a data de criação,
					// que também é uma Date
				return Date.class;
			default:
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case 2: // Terceira colina é o nome do .
