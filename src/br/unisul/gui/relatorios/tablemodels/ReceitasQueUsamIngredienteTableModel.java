 ...
 */
public class ReceitasQueUsamIngredienteTableModel extends AbstractTableModel {
	...
	private String[] colunas = new String[] {
			"Nome Receita", "Nome Autor", "Data Criação"};


	/* Cria um IngredienteTableModel vazio. */
	public ReceitasQueUsamIngredienteTableModel() {
		linhas = new ArrayList<Receita_Ingrediente>();
	}

	/* Cria um IngredienteTableModel carregado com
	 * a lista de ingredientes especificada. */
	public ReceitasQueUsamIngredienteTableModel(List<Receita_Ingrediente> listaDeIngredientes) {
	...
	public Class<?> getColumnClass(int columnIndex) {
		...
		switch (columnIndex) {
		case 0: // Primeira coluna é o nome da receita, que é uma String.
			return String.class;
		case 1: // Segunda coluna é o Nome do autor, que é uma String..
			return String.class;
		case 2: // Segunda coluna é o Nome do autor, que é uma String..
			return String.class;
		default:
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 0: // Primeira coluna é o nome da receita.
			return receita_Ingrediente.getReceita().getNome();
		case 1: // Segunda coluna é o nome do autor.
			return receita_Ingrediente.getReceita().getAutor().getNome();
		case 2: // Terceita coluna é o data.
			return receita_Ingrediente.getReceita().getDataCriacaoFormatada();
		default:
			// Se o índice da coluna não for válido, lança um
			// IndexOutOfBoundsException (Exceção de índice fora dos limites).
			// Não foi necessário verificar se o índice da linha é inválido,
